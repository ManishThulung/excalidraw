        ...
        <Card className="bg-card border border-purple-500/30 p-8 shadow-xl shadow-purple-500/10 relative backdrop-blur-sm">
          ...
          >
            ...
            <Button
              type="submit"
              disabled={isSubmitting}
              className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-accent-foreground font-semibold py-2 h-11 rounded-lg transition-all shadow-lg shadow-purple-500/30 mt-6"
            >
